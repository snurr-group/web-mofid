...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'searchdb.data';
    var REMOTE_PACKAGE_BASE = 'searchdb.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_searchdb.data');

    };
    Module['addRunDependency']('datafile_searchdb.data');
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 6100608,
    DYNAMIC_BASE = 6100608,
    DYNAMICTOP_PTR = 857696;
...
var wasmBinaryFile = 'searchdb.wasm';
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=857552;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 857600, 4), 857600);
...
var _runSearchc = Module["_runSearchc"] = function() {
  return Module["asm"]["_runSearchc"].apply(null, arguments)
};
